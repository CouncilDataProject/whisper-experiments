...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=whisper_experiments whisper_experiments/tests
...
generate-docs:
	rm -f docs/whisper_experiments*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs whisper_experiments **/tests
