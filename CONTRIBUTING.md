...
Ready to contribute? Here's how to set up `whisper-experiments` for local development.

1. Fork the `whisper-experiments` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/whisper-experiments.git
    ```
